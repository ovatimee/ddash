...
const useAsideTouch = () => {
    ...
    const asideWidthWithSpace = (parseInt(String(process.env.REACT_APP_ASIDE_WIDTH_PX), 10) +
        parseInt(String(process.env.REACT_APP_SPACER_PX), 10)) *
        -1;
    const x = useMotionValue(process.env.REACT_APP_ASIDE_TOUCH_STATUS === 'true' ? 0 : asideWidthWithSpace);
