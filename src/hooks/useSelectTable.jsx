...
const useSelectTable = (data) => {
    ...
    useEffect(() => {
        if (ref.current) {
            if (!!selectTable.values.selectedList.length &&
    ...
    const SelectAllCheck = (<Checks ref={ref} id='selectAll' onChange={selectTable.handleChange} checked={selectTable.values.selectAll}/>);
