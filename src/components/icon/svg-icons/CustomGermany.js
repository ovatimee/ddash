...
const SvgCustomGermany = (props) => (<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' style={{
        enableBackground: 'new 0 0 512 512',
    }} xmlSpace='preserve' width='1em' height='1em' className='svg-icon' {...props}>
		<path style={{
        fill: '#464655',
