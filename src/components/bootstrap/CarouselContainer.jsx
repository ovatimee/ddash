...
class CarouselContainer extends Component {
    ...
    render() {
        ...
        if (slidesOnly && children) {
            return (<div style={{ height }} className={outerClasses} onMouseEnter={this.hoverStart} onMouseLeave={this.hoverEnd}>
        ...
        if (children && children[0] instanceof Array) {
            ...
            return (
            // @ts-ignore
            <div style={{ height }} className={outerClasses} onMouseEnter={this.hoverStart} onMouseLeave={this.hoverEnd}>
        ...
        ref={this.props.innerRef} id={id} className={outerClasses} style={{ height }} 
        // eslint-disable-next-line react/destructuring-assignment
        data-bs-ride={this.props.ride === 'carousel' ? 'carousel' : null} 
        // eslint-disable-next-line react/destructuring-assignment
        data-bs-touch={!this.props.enableTouch ? 'false' : null} onMouseEnter={this.hoverStart} onMouseLeave={this.hoverEnd} 
        // @ts-ignore
