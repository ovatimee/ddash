...
const TransferAction = ({ currency, amount, status, img, className, imgWidth, }) => {
    ...
    const STATUS = (status === 'Completed' && 'success') ||
    ...
    return (<Card className={className}>
					...
					<div className='col d-flex align-items-center'>
						<div className='flex-shrink-0'>
							<div className='ratio ratio-1x1' style={{ width: 72 }}>
								<div className={classNames('rounded-2', 'd-flex align-items-center justify-content-center', {
            ...
            'bg-lo25-info': darkModeStatus,
					...
					<div className='col-auto'>
						<div className={classNames(`bg-l${darkModeStatus ? 'o25' : '10'}-${STATUS} text-${STATUS} fw-bold px-3 py-2 rounded-pill`)}>
							{status}
						</div>
					</div>
				</div>
